...
if user_op == '1':
    c = float(input('please inter the temperature in centigrade : '))
    f = c * 1.8 + 32

    print('Fahrenheit degree = ', f)

elif user_op == '2':
    f = float(input('please inter the temperature in fahrenheit : '))
    c = ( f - 32 ) / 1.8
    ...
    k = float(input('please inter the temperature in kelvin : '))
    c = ( k - 273 )
